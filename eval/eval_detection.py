...
def save_dcr_score(file_path, score):
    """
...
#----------------------------------------------------------------
    ...
    dir_path = os.path.join(current_path, f'C2ST_scores/{dataname}')
    file_path = os.path.join(dir_path, f'{model}_C2ST_score.txt')
    
    os.makedirs(dir_path, exist_ok=True)  # create the directory, not the file path
    save_dcr_score(file_path, score)
