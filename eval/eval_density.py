...
def reorder(real_data, syn_data, info):
    ...
    metadata['columns'] = {}
    metadata["column_names"] = [info["column_names"][i] for i in num_col_idx] + [info["column_names"][i] for i in cat_col_idx]
...
if __name__ == '__main__':
    ...
    print(syn_path)
    print(f'Loading info from {data_dir}/info.json')
    ...
    print(f'The info has been saved in {save_dir} as quality.txt, shape.csv, trend.csv, and coverage.csv')
